...
class Helpers
{
  ...
  public static function updatePageConfig($pageConfigs)
  {
    ...
    public static function get_menu_access($user_name)
    {
        $menu_arr = array();
		...
		if(isset($user_name)){
			...
			if(is_array($menu_res->json()['result'])){
				if(count($menu_res->json()['result']) > 0){
					foreach($menu_res->json()['result'] as $menus){
						array_push($menu_arr, $menus['cslug']);
					}
				}
			}
