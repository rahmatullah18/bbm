{{-- aktivitas financial --}}
<div>
    <div class="py-2 px-3 header_table_aruskas">Aktivitas Financial</div>
    <div class="table-responsive text-nowrap px-2">
        <table class="table" id="arus-kas-table-financial">
            <thead class="">
                <tr>
                    <th>No</th>
                    <th>Nomor Akun</th>
            ...
            <tbody class="table-border-bottom-0" x-data="dataFinancial">
