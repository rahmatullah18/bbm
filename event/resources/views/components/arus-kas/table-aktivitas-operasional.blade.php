...
{{-- @dd($dummyData) --}}
@php
$totalAktivitasOperasional = 0;
@endphp
<div>
    <div class="py-2 px-3 header_table_aruskas">Aktivitas Operasional</div>
    <div class="table-responsive text-nowrap ">
        <table class="table">
            ...
            <tbody x-data="dataOperasional">
                ...
                @endforeach
                @php
                $totalAktivitasOperasional += $data[0]['total'];
                @endphp
                @endforeach
                @else
                <tr>
    ...
    <div class="d-flex py-2 px-4 justify-content-between border-top">
        <div class="text-bold text-uppercase">Total Arus Kas Aktivitas Operasional</div>
        <div class="text-bold">{{formatRupiah($totalAktivitasOperasional)}}</div>
    </div>
</div>
